...
function main(param) {
    ...
    scene.onLoad.add(function () {
        ...
        if (typeof window !== "undefined" && typeof window.cv !== "undefined") {
            ...
            videoElem.width = g.game.width;
            videoElem.height = g.game.height;
            ...
            navigator.mediaDevices.getUserMedia({
                ...
                scene.setInterval(()=>{
                    ...
                    //console.log(g.game.age, matSrc);
                    // cv.cvtColor(matSrc, matDst, cv.COLOR_RGBA2GRAY);
                    // cameraSprite._surface = createSurfaceFromMat(matDst, g.game.width, g.game.height);
